    ...
    <div style="padding: 10px;height: 500px;">
        <div>
            <h1 style="text-align: center;">Xin chúc mừng<a href="" target="_blank" style="color: #64b54e;"> nguyễn lan
                </a>đã có người đăng ký làm việc :)</h1>
            <h4 style="text-align: center;color: #64b54e;"><a href="" target="_blank" ">Ứng tuyển công việc:&emsp;
                </a>{{$show_new_work['title']}}</h4>
        </div>
        <div class="container my-4" style="width: 70%;    margin-left: auto;    margin-right: auto;">
            ...
            <p><strong>Trình độ học vấn :<a href="" target="_blank">&ensp; {{$add_work['till_student']}}
                    </a>.</p>
            <p><strong>Kinh nghiệm :<a href="" target="_blank">&ensp; {{$add_work['experience']}}
                    </a>.</p>
